...
lists = [
  { name: "Drama", description: "Filmes emocionantes e profundos" },
  { name: "Comédia", description: "Para dar boas risadas" },
  { name: "Suspense", description: "Prenda o fôlego" },
  { name: "Ação", description: "Muita adrenalina" },
  { name: "Romance", description: "Histórias de amor" },
  { name: "Favoritos", description: "Meus filmes preferidos" },
  { name: "Para ver", description: "Filmes que quero assistir" }
]
